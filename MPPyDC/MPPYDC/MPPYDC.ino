...
void setup() {
  ...
  attachInterrupt(pinEastGreen, ISR_btnEastGreen, RISING);
...
void pwmMov(int dutyCycle) {
  setMovDCMotorBackwards();
   // Set motor direction counterclockwise
      // one rotation
         digitalWrite(pinDCMotorDriveEn,HIGH);
...
void pwmMovBackwards() {
  setMovDCMotorBackwards();
   // Set motor direction counterclockwise
      // one rotation
         ledcWrite(pinDCMotorDriveEn,255);
...
void pwmMovForward() {
  setMovDCMotorForward();
   // Set motor direction counterclockwise
     // one rotation
        ledcWrite(pinDCMotorDriveEn,255);
        Serial.print("Interrupcion yellow");
        Serial.println(255);
        delay(10);
